...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="rtl/bootstrap.min.css">
    <!-- Plugins CSS
        ============================================ -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-7 col-12">
                                <div class="header-top-right">
                                    ...
                                    <div class="content"><a href="#"><i class="zmdi zmdi-twitter"></i></a></div>
                                    <div class="content"><a href="#"><i class="zmdi zmdi-linkedin"></i></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-9 col-12">
                                <div class="mainmenu-area pull-right">
                                    <div class="mainmenu d-none d-lg-block">
                                        <nav>
                                            <ul id="nav">
                                                <li ><a href="index.php" id="a" >صفحه‌اصلی</a>
                                                  
                                                </li>
                                                <li><a href="courses.php" id="b" >در باره</a></li>
                                                <li><a  href="latest-news.php" id="c"> پوشش خبری</a> 
                                                    <ul class="sub-menu">
                                                        <li><a href="latest-news.php">تصاویر </a></li>
                                                        <li><a href="breadcrumb-dark.php"> ویدیوها</a></li>
                                                    </ul>
                                                </li>
                                                <li><a href="text-animation-1.php" id="d">خدمات</a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <li><a href="contact.php" id="e">ارتباطات</a></li>
                                            </ul>
                                        </nav>
                                    </div>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="mobile-menu">
                                    <nav id="dropdown">
                                        <ul id="nav">
                                                <li ><a href="index.html">صفحه‌اصلی</a>
                                                  
                                                </li>
                                                <li><a href="courses.php">در باره</a></li>
                                                <li><a> پوشش خبری </a>
                                                    <ul class="sub-menu">
                                                        <li><a href="latest-news.php">تصاویر </a></li>
                                                        <li><a href="breadcrumb-dark.php"> ویدیوها</a></li>
                                                ...
                                                <li><a href="text-animation-1.php">خدمات</a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <li><a href="contact.php">ارتباطات</a></li>
                                            </ul>
                                    </nav>
                                </div>
                            </div>
