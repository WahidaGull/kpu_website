                            ...
                            <div class="newsletter-form angle">
                                <form action="#" id="mc-form" class="mc-form footer-newsletter fix">
                                    <div class="subscribe-form">
                                        ...
                                        <button id="mc-submit" type="submit">جستجو</button>
                                    </div>
                                </form>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="single-footer-widget">
                                ...
                                <span><i class="fa fa-map-marker"></i>ناحیه هفتم کابل افغانستان</span>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="single-footer-widget">
                            ...
                            <div class="single-footer-widget">
                                ...
                                <div class="instagram-image">
                                    <div class="footer-img">
                                        <a href="#"><img src="img/footer/1.jpg" alt="" class="foo"  ></a>
                                    </div>
                                    <div class="footer-img">
                                        <a href="#"><img src="img/footer/2.jpg" alt="" class="foo"></a>
                                    </div>
                                    <div class="footer-img">
                                        <a href="#"><img src="img/footer/3.jpg" alt="" class="foo"></a>
                                    </div>
                                    <div class="footer-img">
                                        <a href="#"><img src="img/footer/4.jpg" alt="" class="foo"></a>
                                    </div>
                                    <div class="footer-img">
                                        <a href="#"><img src="img/footer/5.jpg" alt="" class="foo"></a>
                                    </div>
                                    <div class="footer-img">
                                        <a href="#"><img src="img/footer/6.jpg" alt="" class="foo"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-7 col-12">
                            <span>Copyright &copy; © 1395 - وزارت تحصیلات عالی افغانستان<a href="#"> </a></span>
                        </div>
